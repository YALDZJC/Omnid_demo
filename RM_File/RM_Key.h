...
inline void RM_Key::UpKey(bool key)
{
    ...
    if(this->NowKey - this->lastKey == 1)this->RisingEdge = true;//设置上升沿信号
    if(this->lastKey - this->NowKey == 1)this->FallingEdge = true;//设置下降沿信号
}
...
inline bool RM_Key::GetRFKey()
{
    return this->FallingEdge | this->RisingEdge;
}
